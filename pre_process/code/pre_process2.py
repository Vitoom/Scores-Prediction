...
if  __name__ == '__main__':
    ...
    sbn.set_style("whitegrid")
    sbn.factorplot(x="feature_percentage", y="value", hue="regr_method", col="feature_select", ci=None, legend=True, data=df_load_regr[df_load_regr["evaluation"].isin(["MSE"])], kind="point", dodge=True, size=10, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=8)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="feature_percentage", y="value", hue="regr_method", col="feature_select", ci=None, legend=True, data=df_perf_regr[df_perf_regr["evaluation"].isin(["MSE"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=6)
    ...
    plt.legend(loc=0)
    sbn.set(font_scale=1.7)
    plt.yticks(np.arange(0, 12, 1), fontsize=22)
