...
if __name__ == '__main__':
    ...
    plt.ylabel('values')
    plt.legend(loc=4)
    plt.title("autoregression predict result", fontsize = 20)
    plt.savefig('../plot/perf_predict_result_AR.png')
    print(invaluate_result)     # (2.0372412109375002, -0.39822152014623935)
