...
if __name__ == "__main__":
    ...
    sbn.factorplot(x="parameter(# of layers)", y="value", hue="evaluation", col="method", ci=None, legend=True, data=df_load_regr, kind="point", dodge=True, size=16, aspect=2)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="parameter(# of trees or # of layers)", y="value", hue="evaluation", ci=None, legend=True, data=df_load_cla[df_load_cla["method"].isin(["rf"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=3)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="parameter(# of trees or # of layers)", y="value", hue="evaluation", ci=None, legend=True, data=df_load_cla[df_load_cla["method"].isin(["mlpc"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=3)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="parameter(# of layers)", y="value", hue="evaluation", col="method", ci=None, legend=True, data=df_perf_regr, kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=3)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="parameter(# of trees or # of layers)", y="value", hue="evaluation", ci=None, legend=True, data=df_perf_cla[df_perf_cla["method"].isin(["rf"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=3)
    ...
    plt.figure(figsize=(8,35))
    sbn.set_style("whitegrid")
    sbn.factorplot(x="parameter(# of trees or # of layers)", y="value", hue="evaluation", ci=None, legend=True, data=df_perf_cla[df_perf_cla["method"].isin(["mlpc"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
    sbn.set(font_scale=3)
