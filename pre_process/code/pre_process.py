...
if  __name__ == '__main__':
    ...
    sbn.set_style("whitegrid")
    sbn.factorplot(x="feature_percentage", y="value", hue="regr_method", col="feature_select", ci=None, legend=True, data=df_load_regr[df_load_regr["evaluation"].isin(["MSE"])], kind="point", dodge=True, size=16, aspect=2)
    plt.tight_layout(pad=3)
